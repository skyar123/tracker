...
export default function SixMonthChecklistModal({ client, onSave, onClose }) {
  // We'll store our checklist state in a local object that mimics the client's saved assessments
  // Or we can just use a local state and save it directly into the client object
  const [formData, setFormData] = useState(client.sixMonthChecklist || {});
  ...
  // Helper to render a checklist row
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-5xl max-h-[90vh] flex flex-col print:shadow-none print:max-h-none print:rounded-none">
        ...
        <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50 rounded-t-2xl print:hidden">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-slate-800">Six Month Assessment Checklist</h2>
              <p className="text-xs text-slate-500">Track 6-month assessment tasks and documentation</p>
            </div>
          </div>
        ...
        <div className="p-8 overflow-y-auto print:overflow-visible print:p-4 print:pt-0">
          ...
          <div className="mb-8">
            <div className="flex justify-between items-start mb-6">
              ...
              <h1 className="text-xl font-bold text-slate-900 uppercase tracking-wide mt-4">Child First 6 Month Assessment Checklist</h1>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-200 print:divide-black">
                ...
                <tr className="bg-slate-100/50 print:bg-gray-100">
                  <td colSpan="5" className="p-2 px-3 font-bold text-sm text-slate-800 border-b border-slate-300 print:border-black">
                    Child Development Assessment:
                  </td>
                </tr>
                ...
                <tr className="bg-slate-100/50 print:bg-gray-100">
                  <td colSpan="5" className="p-2 px-3 font-bold text-sm text-slate-800 border-b border-slate-300 border-t print:border-black">
                ...
                {renderRow('Brief Infant-Toddler Social Emotional Assessment (BITSEA)', 'bitsea', 'Absorb', 'ASD:')}
                {renderRow('Preschool and Kindergarten Behavior Scales 2nd edition (PKBS-2)', 'pkbs2', 'Copyrighted', 'ASD:')}
          ...
          <div className="mt-8 flex justify-between items-center text-xs text-slate-500 font-medium">
            ...
            <span>Child First 6 Month Assessment Checklist</span>
            <span>p. 1 of 1</span>
          </div>
